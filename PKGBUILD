...
license=('GPL2')
source=("plasma-org.kde.plasma.desktop-apple")

sha256sums=('fca1b0878198c2396bf013424d04ce53cd4e2bb0eb43ef942899e5c4dbe361a1')

package() {
    install -D -m644 "plasma-org.kde.plasma.desktop-apple" "${pkgdir}/etc/skel/.config/plasma-org.kde.plasma.desktop-apple"
}
